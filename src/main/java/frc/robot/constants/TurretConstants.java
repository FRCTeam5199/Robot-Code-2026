...
public class TurretConstants {
    ...
    public static final double TURRET_ENCODER_MAGNET_OFFSET = 0.35009766875;
    ...
    public static final double TURRET_MIN = 0d;
    public static final double TURRET_MAX = 355d;
}