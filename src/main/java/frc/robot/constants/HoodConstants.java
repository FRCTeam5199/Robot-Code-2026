...
public class HoodConstants {
    ...
    public static final double HOOD_VELOCITY = 8;
    public static final double HOOD_ACCELERATION = 16;
    public static final double HOOD_JERK = 100;

    public static final double HOOD_LOWER_TOLERANCE = 4;
    public static final double HOOD_UPPER_TOLERANCE = 4;

    public static final double HOOD_MAGNET_OFFSET = 0;
    public static final boolean HOOD_CCW_POSITIVE = true;

    public static final double HOOD_MIN = 0;
    public static final double HOOD_MAX = 0;

    public static final double[][] HOOD_GEAR_RATIO = {{1, 1}};
    public static final double HOOD_MOTOR_TO_SENSOR_GEAR_RATIO = 1d;
    public static final double HOOD_SENSOR_TO_MECH_RATIO = 1d;
}
