...
public class Constants {
    ...
    public static final Translation2d SHUTTLE_LEFT_CORNER = new Translation2d(16, 0.7);
    ...
    public static final Pose3d LEFT_CAMERA = new Pose3d(-.316, -.316, .453, new Rotation3d(0d, Math.toRadians(5d), Math.toRadians(135.218)));
    public static final Pose3d RIGHT_CAMERA = new Pose3d(-.317, .317, .436, new Rotation3d(0d, Math.toRadians(5d), Math.toRadians(-135.218)));
    ...
    public static final double TURRET_BUFFER_SIZE = 2d;
