...
public class Constants {
    ...
    public static final Translation2d RED_SHUTTLE_LEFT_CORNER = new Translation2d(15.809, .1);
    public static final Translation2d RED_SHUTTLE_RIGHT_CORNER = new Translation2d(15.809, 7.05);
    ...
    public static final Translation2d BLUE_SHUTTLE_LEFT_CORNER = new Translation2d(.740, .1);
    public static final Translation2d BLUE_SHUTTLE_RIGHT_CORNER = new Translation2d(.740, 7.05);
