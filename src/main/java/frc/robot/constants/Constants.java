...
public class Constants {
    ...
    public static final Translation2d RED_SHUTTLE_LEFT_CORNER = new Translation2d(15.809, 1d);
    ...
    public static final Translation2d BLUE_SHUTTLE_LEFT_CORNER = new Translation2d(.740, 1d);   //Right
