...
public class Telemetry {
    ...
    private final StructArrayPublisher<SwerveModuleVelocity> driveModuleVelocities = driveStateTable.getStructArrayTopic("ModuleStates", SwerveModuleVelocity.struct).publish();
