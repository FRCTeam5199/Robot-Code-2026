...
//            LinearFilter.movingAverage((int) (0.1 / 0.02));
    ...
    private ShotCalculator() {
        ...
        shooterSpeedLookupTable.put(.997 + Constants.HUB_RADIUS, 47d + 2d);
        shooterSpeedLookupTable.put(1.968 + Constants.HUB_RADIUS, 55d + 2d);
        shooterSpeedLookupTable.put(3.049 + Constants.HUB_RADIUS, 56d + 2d);
        shooterSpeedLookupTable.put(4.0513 + Constants.HUB_RADIUS, 62d + 2d);
        shooterSpeedLookupTable.put(5d + Constants.HUB_RADIUS, 68d + 2d);
